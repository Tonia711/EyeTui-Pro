...
import type { InlineEdit, CompanyRow } from "../types";
...
export function CompaniesSection({
  ...
  const [editingCompany, setEditingCompany] = useState<InlineEdit | null>(null);
  ...
  const handleUpdate = async () => {
    ...
    await onUpdate(editingCompany.id, editingCompany.value);
    setEditingCompany(null);
  };

  const handleRequestDelete = (company: CompanyRow) => {
  ...
  return (
    ...
    >
      ...
      <DeleteCompanyDialog
        ...
        companyName={companyToDelete?.name ?? null}
        onCancel={() => {
          setDeleteDialogOpen(false);
          setCompanyToDelete(null);
        }}
